...
A free, single-user fitness dashboard that pulls Intervals.icu data (COROS Pace 4 → Intervals.icu) into Premium-style trends, personal bests, and training-load analytics.
